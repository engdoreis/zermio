...
//! * **`update(|reg| ...)`**: Fetches the current value, allows modification, and commits the 
//!   result back to memory in a single logical block.
//!
//! ## Register Fields
//!
...
//! | **`in_range(val)`**   | Returns true if val fits in the field.          | `u32` | - |
//!
//! ## Example
